			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Panneau de contrôle</h2>
										...
										<div class="panel panel-default">
											<div class="panel-body bk-primary text-light">
												<div class="stat-panel text-center">
													...
													<div class="stat-panel-title text-uppercase">Utilisateurs totaux</div>
												</div>
											</div>
											<a href="userlist.php" class="block-anchor panel-footer">Détails <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
								</div>
							</div>
